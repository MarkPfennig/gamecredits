...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GameCredits"),
     ...
     * override -datadir in the gamecredits.conf file in the default data directory
     * (to be consistent with gamecreditsd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
