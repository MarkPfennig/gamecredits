...
QString BitmarkUnits::name(int unit)
{
    switch(unit)
    {
    case GMC: return QString("GMC");
    case mGMC: return QString("uGMC");
    case uGMC: return QString::fromUtf8("uGMC");
...
QString BitmarkUnits::description(int unit)
{
    switch(unit)
    {
    case GMC: return QString("GameCreditss");
    case mGMC: return QString("mGameCreditss (1 / 1,000)");
    case uGMC: return QString("uGameCreditss (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
qint64 BitmarkUnits::factor(int unit)
{
    switch(unit)
    {
    case GMC:  return 100000000;
    case mGMC: return 100000;
    case uGMC: return 100;
...
qint64 BitmarkUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case GMC:  return Q_INT64_C(21000000);
    case mGMC: return Q_INT64_C(21000000000);
    case uGMC: return Q_INT64_C(21000000000000);
    default:   return 0;
    }
}
...
int BitmarkUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case GMC: return 8; // 21,000,000 (# digits, without commas)
    case mGMC: return 11; // 21,000,000,000
    case uGMC: return 14; // 21,000,000,000,000
    default: return 0;
    }
}
