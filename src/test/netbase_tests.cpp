...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:40002", "::ffff:127.0.0.1", 40002));
    BOOST_CHECK(TestSplitHost("[::]:40002", "::", 40002));
    BOOST_CHECK(TestSplitHost("::40002", "::40002", -1));
    BOOST_CHECK(TestSplitHost(":40002", "", 40002));
    BOOST_CHECK(TestSplitHost("[]:40002", "", 40002));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:40002", "127.0.0.1:40002"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:40002", "[::]:40002"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
